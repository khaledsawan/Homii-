                                                                ...
                                                                <div class="content-wrapper">
                                                                    <div class="content-header row">
                                                                        <div class="content-header-left col-md-6 col-12 mb-2">
                                                                            <h3 class="content-header-title">  المكاتب العقارية  </h3>
                                                                                            ...
                                                                                            <div class="card-body card-dashboard">
                                                                                                                    ...
                                                                                                                    <div class="btn-group" role="group"
                                                                                                                        ...
                                                                                                                        <a href="{{Route('office.show',$office->id)}}"
                                                                                                                           ...
                                                                                                                           <a href="{{Route('office.edit',$office->id)}}"
                                                                                                                            class="btn btn-outline-success btn-min-width box-shadow-3 mr-1 mb-1">نعديل</a>
                                                                                                ...
                                                                                                <div class="justify-content-center d-flex">
                                                                                                    <div>   <a href="{{route('office.create')}}"
                                                                                                        class="btn btn-outline-info btn-min-width box-shadow-3 mr-1 mb-1">اضافة مكتب جديد</a></div>
                                                                                                </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
