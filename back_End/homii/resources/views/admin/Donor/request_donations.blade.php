                                                                ...
                                                                <div class="content-wrapper">
                                                                    <div class="content-header row">
                                                                        <div class="content-header-left col-md-6 col-12 mb-2">
                                                                            <h3 class="content-header-title">    طلبات التبرع  </h3>
                                                                                                ...
                                                                                                <table
                                                                                                    ...
                                                                                                    @isset($donations)
                                                                                                        @foreach($donations as $value)
                                                                                                            <tr>
                                                                                                                <td>{{$value -> donor -> name }}</td>
                                                                                                                <td>{{$value -> donor -> email }}</td>
                                                                                                                <td>{{$value -> donor -> phone }}</td>
                                                                                                                <td>{{$value -> balance }}</td>
                                                                                                            
                                                                                                                <td>
                                                                                                                    <div class="btn-group" role="group"
                                                                                                                         aria-label="Basic example">
                                                                                                                        <a href="{{route('donor.donation.accept',$value ->id)}}"
                                                                                                                           class="btn btn-outline-success btn-min-width box-shadow-3 mr-1 mb-1">قبول</a>

                                                                                                                           <a href="{{route('donor.donation.reject',$value ->id)}}"
