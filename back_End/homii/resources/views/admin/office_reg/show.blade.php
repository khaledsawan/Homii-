        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">   عرض بيانات المكتب العقاري </h3>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                            ...
                                            aria-label="Basic example">
                                               ...
                                               <a href="{{route('office.register.accept',$register -> id)}}"
                                                class="btn btn-outline-success btn-min-width box-shadow-3 mr-1 mb-1">قبول</a>

                                                <a href="{{route('office.register.delete',$register -> id)}}"
